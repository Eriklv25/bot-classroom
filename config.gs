...
const COURSE_SETUP_TEMPLATE = {
  ...
  students: [
    { selected: false, name: "ACEVES SABORIO SALVADOR MARTÍN", emailName: "Estimado Dr. Salvador", email: "salvador.aceves@itcelaya.edu.mx" },
    { selected: false, name: "AGUILAR NÁJERA CARLOS RAFAEL", emailName: "Estimado maestro Nájera", email: "rafael.aguilar@itcelaya.edu.mx" },
    { selected: false, name: "AGUILERA CAMACHO LUIS DANIEL", emailName: "Estimado Dr. Daniel", email: "daniel.aguilera@itcelaya.edu.mx" },
    { selected: false, name: "AGUILAR CANUTO ANTONIO", emailName: "Estimado Dr. Antonio", email: "aguilarcanuto0@gmail.com" },
    { selected: false, name: "ALCARAZ CARACHEO LUIS ALEJANDRO", emailName: "Estimado Dr. Alcaraz", email: "alejandro.alcaraz@itcelaya.edu.mx" },
    { selected: false, name: "AMEZCUA ALVAREZ CARLOS MANUEL", emailName: "Estimado maestro Carlos", email: "carlos.amezcua@itcelaya.edu.mx" },
    { selected: false, name: "ARROYO RAMÍREZ BENJAMÍN", emailName: "Estimado maestro Benjamín", email: "benjamin.arroyo@itcelaya.edu.mx" },
    { selected: false, name: "ARRIAGA GONZÁLEZ EFREN", emailName: "Estimado maestro Efren", email: "efren.arriaga@itcelaya.edu.mx" },
    { selected: false, name: "ARRIAGA MEDINA ROBERTO EDU", emailName: "Estimado maestro Edu", email: "roberto.arriaga@itcelaya.edu.mx" },
    { selected: false, name: "CAMARILLO GÓMEZ KARLA ANHEL", emailName: "Estimada Dra. Karla", email: "karla.camarillo@itcelaya.edu.mx" },
    { selected: false, name: "COORDINADOR MECÁNICA", emailName: "Estimado maestro Ismael", email: "coordmec@itcelaya.edu.mx" },
    { selected: false, name: "GALLARDO ALVARADO JAIME", emailName: "Estimado Dr. Jaime", email: "jaime.gallardo@itcelaya.edu.mx" },
    { selected: false, name: "GARCÍA MIRANDA J. SANTOS", emailName: "Estimado Dr. Santos", email: "santos.garcia@itcelaya.edu.mx" },
    { selected: false, name: "GUERRERO NAVARRETE ÁNGEL", emailName: "Estimado maestro Angel", email: "angel.guerrero@itcelaya.edu.mx" },
    { selected: false, name: "GUERRERO CHÁVEZ NICOLAS", emailName: "Estimado Dr. Nico", email: "nicolas.guerrero@itcelaya.edu.mx" },
    { selected: false, name: "SORIA PEREZ JAIRO ENOC", emailName: "Estimado maestro Jairo", email: "jesoriap@gmail.com" },
    { selected: false, name: "LOPEZ VARGAS ERIK", emailName: "Estimado maestro Erik", email: "d2403041@itcelaya.edu.mx" },
    { selected: false, name: "LOPEZ VARGAS ERIK", emailName: "Estimado maestro Erik", email: "erik.lopez@itcelaya.edu.mx" },
    { selected: false, name: "MAEDA SÁNCHEZ ARNOLDO", emailName: "Estimado maestro Maeda", email: "arnoldo.maeda@itcelaya.edu.mx" },
    { selected: false, name: "MORENO BELLO KARLA JUDITH", emailName: "Estimada Dra. Karla", email: "karla.moreno@itcelaya.edu.mx" },
    { selected: false, name: "OROZCO MENDOZA HORACIO", emailName: "Estimado Dr. Horacio", email: "horacio.orozco@itcelaya.edu.mx" },
    { selected: false, name: "PANTOJA CUARENTA VICTOR ANTONIO", emailName: "Estimado maestro Victor", email: "victor.pantoja@itcelaya.edu.mx" },
    { selected: false, name: "RAMÍREZ HERNÁNDEZ MIGUEL ÁNGEL", emailName: "Estimado maestro Miguel Angel", email: "miguelangel.ramirez@itcelaya.edu.mx" },
    { selected: false, name: "RICO BAEZA GENARO", emailName: "Estimado Dr. Genaro", email: "genaro.rico@itcelaya.edu.mx" },
    { selected: false, name: "RODRÍGUEZ GARCÍA SAÚL SANTOS", emailName: "Estimado maestro Saúl", email: "saul.rodriguez@itcelaya.edu.mx" },
    { selected: false, name: "RODRÍGUEZ CASTRO RAMÓN", emailName: "Estimado Dr. Ramón", email: "ramon.rodriguez@itcelaya.edu.mx" },
    { selected: false, name: "RUÍZ MONDRAGÓN GILBERTO", emailName: "Estimado maestro Gil", email: "gilberto.ruiz@itcelaya.edu.mx" },
    { selected: false, name: "SÁNCHEZ RODRÍGUEZ ÁLVARO", emailName: "Estimado Dr. Álvaro", email: "alvaro.sanchez@itcelaya.edu.mx" },
    { selected: false, name: "SALMORAN SALGADO ROBERTO CARLOS", emailName: "Estimado maestro Roberto", email: "sasaroca1023@gmail.com" },
    { selected: false, name: "SILVA GARCÍA MIGUEL ANGEL", emailName: "Estimado maestro Miguel Angel", email: "masgtic@gmail.com" },
    { selected: false, name: "SOTO LÓPEZ HUMBERTO", emailName: "Estimado maestro Soto", email: "humberto.soto@itcelaya.edu.mx" },
    { selected: false, name: "TINOCO VILLAGÓMEZ ANTONIO", emailName: "Estimado maestro Tinoco", email: "antonio.tinoco@itcelaya.edu.mx" },
    { selected: false, name: "TORRES VERA ESTEBAN FRANCISCO", emailName: "Estimado maestro Francisco", email: "esteban.torres@itcelaya.edu.mx" },
    { selected: false, name: "NEGRETE RIOS ULISES", emailName: "Estimado maestro Ulises", email: "m2203067@itcelaya.edu.mx" },
    { selected: false, name: "VALADEZ GONZALEZ ELIAS", emailName: "Estimado maestro Elías", email: "d2303005@itcelaya.edu.mx" },
    { selected: false, name: "ZAVALA BUSTOS JOSÉ ALBERTO", emailName: "Estimado maestro Zavala", email: "jose.zavala@itcelaya.edu.mx" },
  ],
  teacherInvitationReminder: {
    ...
    bodyIntro: "Sigue pendiente su invitacion al curso de Classroom. Por favor acepte el curso para poder cargar sus evidencias del semestre. Le agradezco de antemano."
  },
  pendingActivitiesReminder: {
    enabled: true,
    everyDays: 2,
    hour: "10:00",
    bodyIntro: "Le comunico que las siguientes actividades siguen pendientes. Favor de cargar sus evidencias. Le agradezco de antemano."
  },
  ...
  courseWork: [
    ...
    },
    {
      ...
      linksAdjuntos: ["https://drive.google.com/file/d/1oq1YbSdNsTYsomuY57gWt1eM-EacSyzZ/view?usp=sharing"],
      dueDate: null
    },
    {
      enabled: true,
    ...
    },
    {
      ...
      linksAdjuntos: ["https://drive.google.com/open?id=1-lJwpxfGcQ9AUSDHr0wvrWqdXtQocnzQ&usp=drive_fs"],
      dueDate: null
    },
    {
      enabled: true,
      ...
      linksAdjuntos: ["https://drive.google.com/open?id=198SR2biyC94GaL7sh_rYHausJE3OiaXW&usp=drive_fs"],
      dueDate: null
    }
  ]
};
