// Se usa .cjs deliberadamente: Apps Script carga los archivos .js del
// proyecto y no dispone de `require`; .cjs mantiene esta prueba solo en Node.
...
console.log("course_work_due_date.test.cjs: OK");
